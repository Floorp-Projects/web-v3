  ...
  return (
    <div className="container mx-auto px-4 md:px-8 max-w-[90%] lg:max-w-[85%] xl:max-w-[75%] py-16 md:py-24">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-xl mb-12 max-w-3xl">{t("discord.description")}</p>
        <div className="mb-16">
          <a
        ...
        <div className="card bg-base-200 shadow-xl max-w-3xl mx-auto w-full">
          <div className="card-body py-8">
            <h2 className="card-title text-2xl mb-6">{t("discord.whyJoin")}</h2>
            <ul className="space-y-6 text-left">
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                <span>{t("discord.reason1")}</span>
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                <span>{t("discord.reason2")}</span>
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                <span>{t("discord.reason3")}</span>
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
                <span>{t("discord.reason4")}</span>
              </li>
            </ul>
          </div>
        </div>
