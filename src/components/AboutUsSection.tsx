    ...
    <section className="py-12 md:py-24">
      <div className="container mx-auto px-4 md:px-8 max-w-[90%] lg:max-w-[85%] xl:max-w-[75%]">
        ...
        <AnimatedSection animation="fade-up" delay={100}>
          <div className="bg-base-200 rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="md:w-1/2">
                <div className="prose max-w-none">
                  ...
                  <p>{t("aboutUs.philosophy.description")}</p>
                  ...
                  <p>{t("aboutUs.community.description")}</p>
